        ...
        <div className="mt-5 space-y-3">
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="relative flex-1">
              ...
              <input
                type="text"
                placeholder="Search roles e.g. Senior Assistant Director, Sustainability Manager in Singapore..."
                value={searchQuery}
          ...
          {/* Target Titles Quick Search Chips */}
          {candidate.targetTitles && candidate.targetTitles.length > 0 && (
            <div className="flex items-center gap-2 flex-wrap text-xs pt-1">
              <span className="text-gray-400 font-medium text-[11px]">Quick Scout Target Roles:</span>
              {candidate.targetTitles.slice(0, 6).map((title, idx) => (
                <button
                  key={idx}
                  onClick={() => {
                  ...
                  className="px-2.5 py-1 bg-gray-100 hover:bg-blue-50 hover:text-blue-700 hover:border-blue-200 border border-gray-200/80 rounded-xl text-[11px] text-gray-700 font-medium transition-all cursor-pointer flex items-center gap-1"
                >
